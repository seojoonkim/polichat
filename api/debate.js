...
발언을 아래 3단 구조로 작성하고, 각 단 사이에 "||"를 정확히 2번 넣으세요.

📌 3단 구조:
[단1: 핵심 주장 또는 반박 — 1~2문장, 완결된 문장으로 끝낼 것]||[단2: 근거/사례 — 1~2문장, 완결된 문장으로 끝낼 것]||[단3: 결론/촉구 — 1문장]

⚠️ 각 단은 반드시 종결어미(~다, ~요, ~습니다, ~니다)로 끝나야 합니다.
⚠️ "||" 바로 앞 글자가 종결어미가 아니면 잘못된 것입니다.
⚠️ 한 단(||과 || 사이)은 최대 80자를 넘지 마세요.`;
