    ...
    leejunseok: {
      ...
      세부논거: {
        부정선거론: [
          ...
          "전한길이 '결정적 증거 있다'며 10억 사례금 제안했으나 3년째 단 하나의 증거도 제시 못함 — 2023년부터 공개 제안",
          "국민의힘도 부정선거론 공식 채택 거부 — 당론으로 한 번도 채택한 적 없음",
        ...
        보수의정체성: [
          ...
          "동아일보 2026.2.10 인터뷰: '윤석열 시기 한탕주의·검찰주의가 보수를 몰락하게 했다' — 서울신문·동아일보 보도",
          "하버드대 컴퓨터과학·경제학 졸업 — 보수 정치인 중 최고 학력, 데이터 기반 정책 수립 강조",
          "19개 부처→13개 통합 3부총리제, 대통령 권한 축소, 기초의원 정당공천제 폐지 등 구체적 개혁안 제시",
          "국민의힘 당대표 역임(2021.6~2022.8) 최연소 36세 — 보수 세대교체 상징적 시도",
          "전한길은 본명 전유관으로 국민의힘 입당 시도했으나 거부당함 — 자기가 지지한다는 당에서도 안 받아줌",
          "신동아 2026.1.19 인터뷰: '계엄과 탄핵으로부터 떳떳한 유일한 보수 정당이 개혁신당' — 신동아 보도",
          "전한길 유튜브 구독자 53만이지만 실제 선거 출마·당선 경험 0회 — 정치적 책임 없는 평론가",
        ],
        윤석열탄핵: [
          "2024.12.3 비상계엄 선포 직후 즉각 윤석열을 내란수괴로 규정, 국회 탄핵 절차 적극 동참 — BBC 코리아 2024.12.14 보도",
          "2026.2.19 윤석열 내란 1심 무기징역 선고 — '검찰주의 한탕주의 막 내려야' 서울신문 보도",
          "12.3 사태는 국회 해산권이 있었으면 막을 수 있었다 — 대통령 권한 분산 필요성 역설",
          "윤석열 정부 5년간 법인세 감세로 세수 -3.9조 — 현대경제연구원 추산, 경제 실패 증거",
          "2025년 GDP 성장률 0.7%로 추락 — 현대경제연구원 발표, 윤석열 경제 실패의 결과",
          "비상계엄에 찬성한 전한길은 민주주의 파괴 공범 — 비상계엄은 불가피했다는 주장 자체가 내란 동조",
        ...
        젠더페미니즘: [
          ...
          "젓가락 발언(2025.5.27 대선 토론)은 성범죄 심각성을 비유한 것 — 맥락 왜곡 비판에 해명",
          "전한길은 노량진 섹터디 성희롱 발언으로 여학생 조롱 — 카페에서 삭제 시도한 사실 자체가 인정",
          "전한길 차별금지법 반대 영상에서 동성애 혐오 발언 — 나무위키·한겨레 보도",
          "전한길 '이재명 지지자 강간/팔려가라' 막말(2025.11.10) — 여성 대상 성폭력 발언 YTN·헤럴드 보도",
          "개혁신당 2030세대 여성 지지율 상승 — 합리적 젠더 정책이 젊은층에 어필",
        ],
        이준석의혹: [
          "2013년 성 접대 의혹은 2022.9.20 공소시효 만료로 '공소권 없음' 종결 — 검찰 공식 처분",
          "윤핵관(이철규·장제원 등)이 당내 권력투쟁 과정에서 의혹 확대 재생산 — 정치적 공작 정황",
          "성 접대 의혹 제기자를 고소 → 무고죄가 아닌 명예훼손으로 진행 중 — 법적 대응 적극 수행",
          "SW마에스트로는 병무청 공식 인정 대체복무 제도 — 관리지침에 따른 합법적 복무, 특혜 아님",
          "대선 291만표(8.34%) 3위는 양당 구도에서 제3후보 한계 — 2024 총선 개혁신당 비례 3.6%→대선 8.34% 성장",
          "하버드 CS/Econ 졸업은 검증된 사실 — 학력 위조 의혹 제기 자체가 없음",
          "젓가락 발언 후 지지율 하락(15%→8.34%)은 인정하되, 정책 실력과 무관한 이미지 소비 — 본질 회피 비판",
        ],
        전한길막말: [
          "2025.11.10 '이재명 지지자 강간 당하고 팔려가라' 막말 — YTN·헤럴드경제 보도, 대통령 비서실장도 조처 언급",
          "노량진 섹터디 성희롱 발언 — 여학생에게 성적 모욕, 전한길 카페에서 관련 글 삭제 시도",
          "100억 건국펀드 모금(최소 1000만원 단위) — 불법 정치자금 모금 소지, 정치자금법 위반 가능성",
          "3권분립 폐지 주장 — 대한민국 헌법 기본원리 부정, 헌정질서 파괴 공개 선동",
          "국호 변경·발해 수복 주장 — 비현실적 선동으로 보수층에서도 황당 반응",
          "본명 전유관으로 국민의힘 입당 시도 → 입당 거부 — 정체 숨기고 접근한 기만 행위",
          "'이준석도 부정선거로 당선됐다' 주장 — 자기 논리대로면 이준석 동탄 당선도 부정선거, 자기모순",
          "한국일보 2025.1.23 보도: 선관위가 의혹 설명하러 찾아오자 '오지 마라' 거부 — 대화 자체를 회피",
        ],
        자유토론: [
          "부정선거 소송 126건 전부 기각, 대법원·고등법원 단 1건도 인용 없음 — 사법부 최종 판단",
          "TV조선 2026.2.13 '비과학적 발언 팩트체크 불가' 중계 거부 — 보수 언론마저 외면",
          "전한길 10억 사례금 제안 후 3년째 증거 미제시 — 허풍의 결정적 증거",
          ...
          "여성가족부→인권부 개편, 여성희망복무제 — 진보적이지도 보수적이지도 않은 합리적 젠더 정책",
          "전한길 이재명 지지자 강간 발언(2025.11.10) — 정치인 자격 없는 막말",
          "전한길 건국펀드 100억 모금 — 불법 정치자금 소지",
    ...
    jeonhangil: {
      ...
      세부논거: {
        부정선거론: [
          ...
          "한국일보 2025.1.23: 선관위가 의혹 해명하러 찾아왔으나 전한길이 거부한 것이 아니라, 선관위 해명이 불충분해서 재방문 요구",
          "126건 소송 기각은 '증거 불충분'이지 '부정선거 없었다'는 판단 아님 — 소극적 기각과 적극적 부인은 다름",
        ],
        보수의정체성: [
          "유튜브 구독자 53만+ '전한길TV' — 보수 시민 교육 최대 채널, 풀뿌리 보수 결집 플랫폼",
          "한국사 일타 강사 출신으로 역사적 정통성 기반 보수 정체성 교육 — 수능 강의 경력 20년+",
          "이준석은 원래 노사모(노무현 지지) 출신 진보 → 보수 전향 — 일관성 부족, 기회주의적 전향",
          "이준석 국민의힘 탈당(2023.12) — 보수 진영 분열의 직접적 원흉, 당 해체 시도",
          "윤석열 대통령 중심 보수 결집 주장 — 지도자 중심 단결이 보수의 전통적 가치",
          "제2건국 비전 제시: 대한민국 재건국 통한 체제 혁신 — 이승만 건국 정신 계승",
          "이준석 하버드 학벌 엘리트주의 — 국민 위에 군림하는 태도, 보수 서민층과 괴리",
          "개혁신당 대선 291만표(8.34%) 3위 참패 — 국민이 이준석식 보수를 거부한 증거",
        ],
        윤석열탄핵: [
          "비상계엄은 선관위 부정선거 수사 위한 불가피한 조치 — 일반 수사로는 선관위 접근 불가능했음",
          "2026.2.19 내란 1심 무기징역은 부당판결 — 사법부 편향, 항소심에서 뒤집힐 것",
          "12.3 비상계엄 6시간 만에 자진 해제 — 쿠데타 의도 없었다는 증거",
          "이재명 정부의 검찰 무력화·사법 장악이 진짜 민주주의 위기 — 탄핵은 정치 보복",
          "탄핵소추안 투표 시 국민의힘 일부 이탈표는 당내 분열(이준석 세력) 때문 — 배신자 존재",
          "윤석열 재임 중 한미동맹 강화·캠프데이비드 합의(2023.8) — 외교 성과 무시 못함",
          "헌법재판소 탄핵 인용(2025.4.4)은 정치적 결정 — 8인 재판관 구성 자체가 편향",
        ],
        젠더페미니즘: [
          "이준석 젓가락 발언(2025.5.27 대선 토론) — 성폭력을 가볍게 비유, 대통령 후보 자질 의문. 지지율 15%→8.34% 급락",
          "차별금지법 반대 — 동성 성관계 교육 강제, 표현의 자유 침해 우려. 프리진뉴스 2024.10.29 보도",
          "전통 가족 가치 수호 — 건강한 가정이 건강한 사회의 기초, 보수적 가족관은 한국 전통",
          "이준석 여성가족부 폐지 공약은 여성 보호 체계 해체 — 대안 없는 폐지는 무책임",
          "이준석 여성희망복무제는 비현실적 — 여성 징병은 국방부도 반대, 실현 불가능 포퓰리즘",
          "저출생 문제 해결은 가족 지원·출산 장려 정책 — 페미니즘적 개인주의가 저출생 심화",
          "이준석의 '합리적 젠더' 정책은 실체 없는 중도 포장 — 구체적 입법 성과 0건",
        ],
        이준석의혹: [
          "2013년 성 접대 의혹 — 공소시효 만료 '공소권 없음'(2022.9.20)은 무죄가 아님, 실체 미규명",
          "의혹 제기자 고소 → 역으로 무고죄 피소, 항고 심리 중 — 떳떳하면 왜 역고소당하나",
          "SW마에스트로 병역 특혜 — 병무청 관리지침 위반 의혹, 공정 외치면서 본인은 특혜",
          "대선 291만표(8.34%) 3위 참패 — 국민이 심판, 이준석 정치 실험 실패 증명",
          "젓가락 발언(2025.5.27) — 지지율 15%→8.34% 폭락 직접 원인, 자기 입으로 자기 무덤",
          "국민의힘 당대표 시절 윤핵관과 갈등 → 결국 탈당 — 조직 관리 무능력, 분열 유발자",
          "'의원직 걸어라' 도발에 무응답 — 자신감 없으면 왜 못 걸어?",
          "원래 노사모 출신(노무현 팬카페 가입) — 진보→보수 전향의 기회주의적 행보",
        ],
        전한길막말: [
          "정치 탄압이고 맥락 왜곡 — 강간 발언은 북한 체제의 참상을 설명하는 맥락에서 나온 것",
          "표현의 자유 영역 — 정치적 발언을 막말로 프레이밍하는 것 자체가 언론 검열",
          "이준석 측이 막말 프레임 씌우는 것은 정책 토론 회피 전략 — 본질 흐리기",
          "노량진 섹터디 발언은 유머 맥락 — 당시 강의 분위기에서의 농담, 심각한 성희롱 아님",
          "건국펀드는 합법적 후원금 — 정치자금법상 개인 후원 한도 내, 불법 아님",
          "YTN·헤럴드 보도는 편향 보도 — 전체 맥락 없이 일부만 발췌, 왜곡 보도",
          "이준석도 '싸가지 없다' 비판 받는 막말 상습범 — 본인도 막말하면서 남 비판은 이중잣대",
        ],
        자유토론: [
          "국정원 2023.7 선관위 해킹 취약점 발견 — 부정선거 가능성 국가기관이 확인",
          "선관위 감사원 감사 거부(2023) — 할 말 없으면 왜 거부하나",
          "사전투표 vs 당일투표 편차 — 통계적 이상치 미시간대 교수 분석",
          "유튜브 53만 구독 전한길TV — 보수 시민 교육 최대 플랫폼",
          "이준석 노사모 출신 → 보수 전향 — 기회주의적 정치 행보",
          "이준석 성 접대 의혹 공소권 없음 ≠ 무죄 — 2022.9.20 검찰 처분",
          "이준석 젓가락 발언으로 지지율 15%→8.34% 폭락 — 2025.5.27 대선 토론",
          "대선 291만표 3위 참패 — 국민의 심판",
          "이준석 SW마에스트로 병역 특혜 — 공정 외치면서 본인은 예외",
          "윤석열 한미 캠프데이비드 합의(2023.8) — 외교 성과 인정해야",
          "비상계엄 6시간 자진 해제 — 쿠데타 의도 없었음 증거",
          "이준석 국민의힘 탈당 — 보수 분열 원흉",
...
function getKnowledge(topicLabel, speaker) {
  ...
  if (['leejunseok', 'jeonhangil'].includes(speaker)) {
    ...
    const conflicts = lj.핵심쟁점.filter(c => {
      ...
      if (/논란|의혹|스캔들|막말/.test(topicLabel)) return /이준석 의혹|전한길 막말/.test(c.주제);
      return false;
    }).slice(0, 3);
...
규칙: 반드시 총 4문장 이내. 완성된 문장으로 끝낼 것. 수치·사례 최소 1개. 이준석을 "가짜 보수", "위장 보수"로 공격. 실제 전한길 스타일로.`,
  ...
  if (kb.myPosition || kb.conflicts.length > 0 || kb.seoulContext) {
    ...
    if (kb.세부논거) {
      const topicMap = {
        '부정선거론': '부정선거론', '부정선거': '부정선거론',
        '보수의 정체성': '보수의정체성', '보수정체성': '보수의정체성', '보수 정체성': '보수의정체성',
        '윤석열 탄핵': '윤석열탄핵', '탄핵': '윤석열탄핵',
        '젠더·페미니즘': '젠더페미니즘', '젠더': '젠더페미니즘', '페미니즘': '젠더페미니즘',
        '이준석 의혹': '이준석의혹', '의혹': '이준석의혹',
        '전한길 막말 논란': '전한길막말', '막말': '전한길막말', '전한길 막말': '전한길막말',
      };
      const argKey = topicMap[topic] || '자유토론';
