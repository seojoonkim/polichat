...
가능한 각도: ① 새로운 사실/수치 ② ${opponentName} 말 인용+반박 ③ 제3자 증언/보도 ④ 역사적 선례 ⑤ 논리적 모순 지적 ⑥ 개인 신뢰성 공격 ⑦ 정책 효과 비판`;
  ...
  // ── 말풍선 분리 규칙: 균등 3분할 강제 ───────────────────────────────────────
  systemPrompt += `\n\n🧩 말풍선 균등 분리 규칙 (필수 — 반드시 지킬 것)

발언 전체를 반드시 "||"로 구분해 3개의 말풍선으로 나누세요. 즉 "||"는 정확히 2번 들어가야 합니다.

균등 분배 원칙:
- 말풍선 1·2·3이 비슷한 글자 수(±30%)가 되도록 균등하게 나눠야 합니다.
- 앞 두 말풍선에 지나치게 짧은 1~2단어만 넣거나, 마지막 말풍선에만 내용이 몰리는 것은 금지입니다.

분할 기준 (마침표가 없어도 아래 위치에서 나눠도 됩니다):
① 종결 어미(~다, ~요, ~죠, ~네) 직후
② 쉼표(,) 또는 긴 호흡 뒤
③ 접속어("그리고", "하지만", "또한", "따라서", "이를테면") 직전
④ 내용 단위가 새로운 논거·사례로 전환되는 지점

❌ 금지: "그렇습니다.||진짜입니다.||[긴 본론 전체]" 처럼 앞에 짧은 감탄만 넣고 마지막에 몰아넣는 구조
✅ 올바른 예: [논거A 1-2문장]||[논거B 1-2문장]||[마무리·결론 1문장]

4문장 이내 전체 분량을 3등분하세요.`;
