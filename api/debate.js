    ...
    jeonhangil: {
      ...
      세부논거: {
        ...
        논란의혹: [
          ...
          // 전한길 방어
          "강간 발언은 북한 체제 참상을 설명하는 맥락에서 나온 것 — 정치 탄압, 맥락 왜곡",
          "표현의 자유 영역 — 정치적 발언을 막말로 프레이밍하는 것 자체가 언론 검열",
          "이준석 측이 막말 프레임은 정책 토론 회피 전략 — 본질 흐리기",
          "노량진 섹터디 발언은 강의 맥락 — 심각한 성희롱으로 과장됨",
          "건국펀드는 합법적 후원금 — 정치자금법상 개인 후원 한도 내",
  ...
  if (kb.myPosition || kb.conflicts.length > 0 || kb.seoulContext) {
    ...
    if (kb.세부논거) {
      const topicMap = {
        ...
        '논란·의혹': '논란의혹', '이준석 의혹': '논란의혹', '전한길 막말 논란': '논란의혹',
        '의혹': '논란의혹', '막말': '논란의혹', '논란': '논란의혹',
      };
